        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScenarioFeedback = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    TrainingFeedback = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EducationGroup = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ProfessionalExperience = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HasFormalTraining = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HasInformalTraining = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhishingConfidence = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    SpearPhishingConfidence = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParticipantSurveyCompletionTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    BaselineSurveyCompletionTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EvaluationCompletionTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    PostgameSurveyCompletionTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    FeedbackCompletionTime = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 19, "N/A", true, 5, "You provide the caller with a number to the trial manager who is qualified to handle this type of requests.", 3 },
                    { 20, "N/A", false, 5, "Using your access to the database, you assign yourself the necessary permissions to enter the website and perform the request. With the emergency resolved, you remove the permissions and notify the nurse of the crisis averted.", 4 },
                    { 21, "N/A", true, 6, "You decide to report the e-mail to the university IT support as spam and remove it from your inbox.", 1 },
                    { 22, "N/A", false, 6, "You knew that working hard and getting good grades in first year will reward you somehow. You lose no time to apply for the position to increase your chance of getting the position.", 2 },
                    { 23, "N/A", false, 6, "You tell the recruiter about your suspicions and ask them to contact you on LinkedIn where you can see more information about them.", 3 },
                    { 24, "N/A", false, 6, "You open the link using a Private (or Incognito) mode of your web browser as a protective measure. If the website seems fine, apply for the position.", 4 },
                    { 25, "N/A", false, 7, "Following the call, you immediately call the number the VIP called from yesterday. You help them regain access and ask them for new verification questions.", 1 },
                    { 26, "N/A", false, 7, "You ignore the caller's request and report the number he called from to the security. You are sure your boss would not ask you to ignore important security features.", 2 },
                    { 27, "N/A", true, 7, "Before you do anything, you call your management to verify the number belongs to the CEO. With their response you decide whether to perform the request or report the number to the security.", 3 },
                    { 28, "N/A", false, 7, "You call your boss back and ask some questions about the client to verify their identity as an alternative to verification questions they forgot.", 4 },
                    { 29, "N/A", true, 8, "You send the corrected e-mail address to the student and let them know about the previous address being incorrect.", 1 },
                    { 30, "N/A", false, 8, "To make up for the mistake, you decide to forward the file with questions to the employee who organised the event and tell them about the student and the e-mail mistake. You ask them to look at the questions and answer them when they have a spare moment.", 2 },
                    { 31, "N/A", false, 8, "You mark the message as spam, report the sender, and warn your colleagues about scammers on social media inbox.", 3 },
                    { 32, "N/A", false, 8, "Call the school the student is studying in to verify his identity and authority as a school journalist. If the sender is telling truth, provide them with the corrected e-mail address. Otherwise, mark the message as spam, report sender, and warn your colleagues about a scammer.", 4 },
                    { 18, "N/A", false, 5, "You refuse to perform the requested action and hang up.", 2 },
                    { 17, "N/A", false, 5, "You tell the nurse that your staff account is not authorised to access the website, but if they give you the password to their account, you can log in and perform the request on their behalf.", 1 },
                    { 7, "N/A", true, 2, "Refuse to provide the caller with any information and advise them to contact the company department authorized to handle such requests. You also notify the company security of the potential police impostors.", 3 },
                    { 15, "N/A", false, 4, "You forward the e-mail to the security department, informing them of malicious spam, and ignore the request.", 3 },
                    { 14, "N/A", true, 4, "You contact your company's HR department to notify them of the e-mail and verify the legitimacy of the sender. Based on what they say, provide the agent with the requested data or refuse.", 2 },
                    { 13, "N/A", false, 4, "You check the company website to verify their legitimacy and provide the agent with all the information they need.", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 12, "N/A", false, 3, "You refuse to help the student and go home.", 4 },
                    { 11, "N/A", false, 3, "You let the student in, and after wishing the good luck, you head home.", 3 },
                    { 10, "N/A", true, 3, "You let your classmate into the building, but only if you can accompany him the entire time and you will leave the building together.", 2 },
                    { 9, "N/A", false, 3, "You tell the your classmates that you cannot let them in and they should seek assistance from the security.", 1 },
                    { 8, "N/A", false, 2, "Refuse to provide the caller with any information and advise them to contact the company department authorized to handle such requests. Following their warning, you keep the call and its contents confidential.", 4 },
                    { 16, "N/A", false, 4, "You call the agent's number, found in their signature, to ask more questions and decide whether to provide the data based on the agent's responses.", 4 },
                    { 6, "N/A", false, 2, "You tell the caller you cannot help them as you are out of office right now. You tell them your office hours tomorrow so they can call you there.", 2 },
                    { 5, "N/A", false, 2, "Provide the caller with any information they need to aid the investigation and keep the call a secret.", 1 },
                    { 4, "N/A", false, 1, "Ask the caller what company they work for so you can call them and verify the caller's identity as their employee.", 4 },
                    { 3, "N/A", true, 1, "You refuse to provide the phone number. Instead, you request the driver to hand the wallet to the local police department and e-mail the student to tell them about the wallet and to contact the police.", 3 },
                    { 2, "N/A", false, 1, "You refuse to provide the contact details, hang up, and return to your regular tasks.", 2 },
                    { 1, "N/A", false, 1, "You provide the caller with the student's phone number and send an e-mail to the student to let them know the taxi driver called you and will get in touch with them soon.", 1 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 4, "It has been almost half a year since you began working in this company and you are soon you will be eligible for employee benefits like health insurance and a pension scheme enrolment. You receive an e-mail from an external address informing you that you will be soon enrolled into a pension scheme. You must provide your staff ID, National Insurance Number, date of birth, place of residence, and some other personal data. The e-mail is well written and the sender mentions they work for a company hired by your employer to handle pensions and wages. The signature of the e-mail contains a phone number and links to the company websites. The website matches the domain of the sender's e-mail address.", "The requested information are your own personal identifiable data which means you don't need authorisation to share them. Since the request is unusual, coming from an address and company unknown to you, the sender's credibility and authority to collect these data should be verified with a third party that you are familiar with and trust." }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new Guid("c43e55f6-cf02-4cc2-bbd6-601b37f0beb1"), "SEADM" },
                    { 2, new Guid("7a8d2920-cb1c-4f7b-8513-1dc19a2c9634"), "Feedback" }
                });

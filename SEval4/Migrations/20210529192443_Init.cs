    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 7, "Ignore and block", false, 2, "Ignore the email and remove the recruiter from your LinkedIn.", 3 },
                    { 8, "Use the number to arrange a meeting", true, 2, "Give the recruiter a call on one of the two numbers provided and arrange to meet up with him to discuss how he can help you.", 4 },
                    { 6, "Accept immediately and provide too much data", false, 2, "You have been job hunting for ages and see this as a blessing in disguise. You reply to the email saying that you would appreciate his help and attach a copy of your CV, a copy of your ID and a link to your GitHub account. (Since you know he will most likely request all this information anyway.", 2 },
                    { 5, "Click on the links and decide later", false, 2, "Click on the links provided, and have a look at the company’s online profile as well as reviews left by others. If all seems good, get in contact with the recruiter.", 1 },
                    { 3, "Accept immediately", false, 1, "Instantly provide her with your login details and wish her a merry Christmas.", 3 },
                    { 2, "Refer to colleague", false, 1, "Ask her to contact one of your colleagues since you are on holiday.", 2 },
                    { 1, "Refuse immidately", true, 1, "Refuse to help her entirely and hang up the phone.", 1 },
                    { 4, "Ask more questions and decide later", false, 1, "Ask her a few complementary questions and based on her answers either provide her with your login details or don’t provide her with any information.", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("56a14a67-9c6d-4679-9d0e-1288ad1ffd40"), "SEADM" },
                    { new Guid("d3824a94-104f-4448-96bc-539a131366a8"), "Feedback" }
                });
